...
const Login = () => {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    setTimeout(() => {
      ...
      setLoading(false);
      // Redirect to dashboard (could be client or photographer based on user type)
      navigate("/dashboard");
    }, 1500);
  };
      ...
      <div className="w-full max-w-md">
        ...
        <Card className="p-8 shadow-elegant">
          <div className="text-center mb-8">
            ...
            <p className="text-muted-foreground">Log in to your FrameBook account</p>
          </div>
          ...
          <div className="my-6">
            ...
            <div className="relative flex justify-center text-xs uppercase">
              <span className="bg-card px-2 text-muted-foreground -mt-3">Or continue with</span>
            </div>
          </div>
